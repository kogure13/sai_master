<div id="slider-wrapper">
    ...
    <div id="slider" class="nivoSlider">
        ...
        <img src="theme/asset/css/images/slider/walle.jpg" alt="" title="#walle"/>
    ...
    <div id="walle" class="nivo-html-caption">
        <strong>This</strong> is an example of a <em>HTML</em> caption walle with <a href="#">a link</a>.
    </div>
</div>
