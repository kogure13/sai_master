	...
	<div class="col-md-12 col-sm-12 col-xs-12">		
		<div class="x_panel">
			<div class="x_content">
				...
				<div id="berita_field" style="display: none;">
					<h4 id="berita_field_title"></h4>

					<form method="post" id="form_berita" novalidate="novalidate">
						...
						<div class="form-group">                			
							<input type="text" name="judul" id="judul" class="form-control required" placeholder="Judul berita">
						</div>
						<div class="form-group">
