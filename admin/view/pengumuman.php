	...
	<div class="col-md-12 col-sm-12 col-xs-12">		
		<div class="x_panel">
			<div class="x_content">
				...
				<div id="pengumuman_field" style="display: none;">
					<h4 id="pengumuman_field_title"></h4>

					<form method="post" id="form_pengumuman" novalidate="novalidate">
						...
						<div class="form-group">                			
							<input type="text" name="judul" id="judul" class="form-control required" placeholder="Judul pengumuman">
						</div>
						<div class="form-group">
