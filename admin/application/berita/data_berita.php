...
class CRUD {
    ...
    function insertData($params) {
        ...
        $sql = "INSERT INTO master_berita";
        $sql .= " (judul, berita, created_date)";
    ...
    function updateData($params) {
        ...
        $sql = "UPDATE master_berita";
        $sql .= " SET judul = '".addslashes($params['judul'])."', berita = '".addslashes($params['konten'])."', modified_date = '".$params['date']."'";
